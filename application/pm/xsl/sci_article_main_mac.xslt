...
<html
   ...
   <head>
      ...
      <link rel="stylesheet" type="text/css" media="all" href="http://www.sciencemag.org/site/global_styles.css" /><script type="text/javascript">var callbackToken='52311FAAE6B018F';</script><script type="text/javascript"
			...
			var OAS_taxonomy = 'subject=CELL_BIOL';
			var OAS_demo_val = '|Employ-Sector=D|Job-Function=X|Discipline-1=19|Discipline-2=40|Discipline-3=44|Discipline-4=25|Discipline-5=68|Highest-Degree=A|';
        ...
        var OAS_sitepage = window.location.hostname + window.location.pathname;
			...
			var OAS_usertype = 'INDV';
		</script><script type="text/javascript" src="http://www.sciencemag.org/publisher/js/oas_ads.js"></script>
...
<xsl:when test="$articleWorkflow eq 'desktop' and @position eq 'float'"><a href=""><img alt="{label}" src="file:///Volumes/mag1/Shared/MAC/WWW/HIGHWIRE/{$articleVol}/{$articleMonthSpelled}/{$articleDay}%20{$articleMonthSpelled}--{$articleIssue}/images/small/{graphic/@xlink:href}.gif" /></a></xsl:when>
<xsl:when test="$articleWorkflow eq 'desktop' and @position eq 'anchor'"><a href=""><img alt="{label}" src="file:///Volumes/mag1/Shared/MAC/WWW/HIGHWIRE/{$articleVol}/{$articleMonthSpelled}/{$articleDay}%20{$articleMonthSpelled}--{$articleIssue}/images/medium/{graphic/@xlink:href}.gif" /></a></xsl:when>
...
<img class="inline-graphic" src="file:///Volumes/mag1/Shared/MAC/WWW/HIGHWIRE/{$articleVol}/{$articleMonthSpelled}/{$articleDay}%20{$articleMonthSpelled}--{$articleIssue}/images/medium/{@xlink:href}.gif" />
   </xsl:template>
