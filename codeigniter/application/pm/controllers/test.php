...
>>>>>>> .r1578
    ...
    $data['content'] .= "cover caption: " . $issue->get_cover_caption() . "<br/>";

    $data['content'] .= "<br/>get_cover_caption_asHTML: " . $issue->get_cover_caption_asHTML() . "<br/>";
...
=======
    $Article = $issue->new_article($get_article_list[4]);
>>>>>>> .r1578
    ...
    $data['content'] .= "<strong>abstract</strong> (default): " . $Article->get_abstracts() . "<br/><hr>";
  ...
  function authors() {
    ...
    $data['content'] = "";
    $i = 0;
   // $maxAuthors = (count($authors) < 4) ? count($authors) : 4;
    $data['content'] = $articles[32]->get_authors_toString();
    $data['content'] .= "<p/>With and formatting<p/>";
    $data['content'] .= $articles[32]->get_authors_toString(5);
    
    $data['title'] = "Author test";
		$this->load->view('pagewrapper-tb', $data);
  }
 }
?>
